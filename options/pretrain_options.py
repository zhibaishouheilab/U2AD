...
class Pretrain_Private_Options():
    def __init__(self):
        ...
        self.parser.add_argument("--masking_ratio", default=0.75,type=float) #原来是0.7
        self.parser.add_argument("--num_workers", default=36, type=int) #36
        
        self.parser.add_argument('--use_checkpoints', default=False) # True
        self.parser.add_argument('--img_save_path', type=str,default='./snapshot/pretrain/baseline/')
        self.parser.add_argument('--weight_save_path', type=str,default='./weight/pretrain/baseline/')
        self.parser.add_argument('--checkpoint_path', type=str,default='./weight/EdgeMAE/MAE.pth')
        # './weight/EdgeMAE/MAE.pth'
        self.parser.add_argument("--data_root", default='../data/public/train/')
        ...
        self.parser.add_argument("--log_path", default='./log/pretrain/baseline.log')
